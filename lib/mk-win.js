...
const MKWin = function (evtTarget) {
  ...
  */
  ...
  const windowProcJSCallback = (hwnd, msg, wp, lp) => { // LRESULT CALLBACK WindowProc(hwnd, msg, wp, lp)
    let ret;
    if (msg == WM_CREATE) {
